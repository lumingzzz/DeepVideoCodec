...
bpp, psnr = [0.04748], [35.916146414620535] 
Hyper, = plt.plot(bpp, psnr, "y-o", color="blueviolet", linewidth=LineWidth, label='Ours (Hyper)')

bpp, psnr = [0.041], [35.94428961617606] 
Context, = plt.plot(bpp, psnr, "y-o", color="darkorange", linewidth=LineWidth, label='Ours (Context)')
...
bpp, psnr = [0.024084804244228597, 0.03651176516272937, 0.059957905238011984, 0.1147673366261491], [35.56770265752238, 36.60666254158722, 37.65684828315908, 38.641819187612235]
DMC, = plt.plot(bpp, psnr, "c-o", color="green", linewidth=LineWidth, label='DMC')
...
bpp, psnr = [0.26837932535089654, 0.1650409111368313, 0.09170101571685774, 0.06272838702417695, 0.04050920184817754, 0.029524148249191657, 0.01990065012308936, 0.014519469246031745, 0.010520419973544973], \
                    [39.60924215969585, 38.8901701746952, 38.023744899602164, 37.39964779998575, 36.605136100025405, 35.95015586132095, 35.1050653273151, 34.382187936987194, 33.63258020863646]
VTM, = plt.plot(bpp, psnr, "b--v", linewidth=LineWidth, label='VTM-18.0')
...
plt.legend(handles=[HM, VTM, DVC, DVCp, FVC, DCVC, DMC, Hyper, Context], loc=4)
plt.grid()
plt.xlabel('Bpp')
plt.ylabel('PSNR')
